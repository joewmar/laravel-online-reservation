<x-landing-layout>
  ...
  <x-full-content >
    <article class="mx-auto prose-lg p-10 w-full md:w-[60%]" id="story">
  ...
  <x-full-content >
    <article class="mx-auto prose-lg p-10 w-full" id="story">
      <h2 class="text-center font-extrabold">Meet our team</h2>
      <div class="flex justify-around w-full gap-5">
        <div class="flex flex-col items-center p-10">
          <img src="{{asset('images/avatars/no-avatar.png')}}" class="w-32 rounded-full" />
          <h3 class="font-bold text-xl">Juan Dela Cruz</h3>
        </div>
        <div class="flex flex-col items-center p-10">
          <img src="{{asset('images/avatars/no-avatar.png')}}" class="w-32 rounded-full" />
          <h3 class="font-bold text-xl">Juan Dela Cruz</h3>
