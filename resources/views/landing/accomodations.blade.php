    ...
    <x-navbar :activeNav="$activeNav" />
          ...
          <swiper-container class="mySwiper h-screen rounded" keyboard="true" space-between="30" pagination="true" pagination-clickable="true" navigation="true" rewind="true" effect="fade">
              ...
              <div class="hero min-h-screen">
                ...
                <div class="hero-content text-center text-neutral-content" class="w-auto h-auto">
                  <div class="max-w-md text-base-100">
                    <h1 class="mb-5 text-2xl md:text-4xl font-bold">Tour Destination</h1>
                  </div>
                </div>
              </div>
            </swiper-slide>
              ...
              <swiper-slide class="rounded-md">
                <div class="hero min-h-screen" style="background-image: url({{asset('storage/'. $item['image'])}});">
                  ...
                  <div class="hero-content text-center text-neutral-content">
                    <div class="max-w-md text-base-100">
                      <h1 class="mb-5 text-2xl md:text-4xl  font-bold">{{$item['title']}}</h1>
                      <p class="mb-5 text-sm md:text-lg">{{$item['location']}}</p>
                    </div>
                  </div>
                </div>
              </swiper-slide>
            ...
            <swiper-slide class="rounded-md">
              <div class="hero min-h-screen">
                ...
                <div class="hero-content text-center text-neutral-content" class="w-auto h-auto">
                  <div class="max-w-md text-base-100">
                    <h1 class="mb-5 text-2xl md:text-4xl font-bold">Side Tour</h1>
                  </div>
                </div>
              </div>
            </swiper-slide>
          ...
          <div  class="w-full px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-y-8 lg:gap-x-16 px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8" >
              <div class="w-full flex flex-col items-center">
                <h2 class="text-2xl md:text-4xl">Tour Services</h2>
        
                <p class="max-w-2xl mt-4 text-gray-600 text-center text-sm md:text-lg">
              ...
              @foreach ($categories as $category)
                <article class="my-5">
                  <h2 class="text-lg md:text-2xl font-bold mb-3">{{$category->category}}</h2>
                    ...
                    @foreach($tour_menu as $menu)
                      @if($category->category === $menu->tourMenu->category)
                        @if($menu->tourMenu->id !== $menu_id)
                          <label class="block rounded-xl border border-gray-300 p-4 shadow-md hover:border-gray-500 hover:ring-1 hover:ring-gray-400 focus:outline-none focus:ring" >
                            <span class="inline-block rounded-lg bg-gray-50 p-3 text-sm md:text-lg">
                              <i class="fa-solid fa-location-pin"></i>
                            </span>
                            <h2 class="mt-2 font-bold text-sm md:text-lg">{{$menu->tourMenu->title}}</h2>
                            <ul class="ml-5 text-xs sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
                              @foreach (explode('(..)', $menu->tourMenu->inclusion) as $item)
                                  <li>&#10003; {{$item}}</li>
                              @endforeach
                            </ul>
                            <div class="mt-5">
                              <h3 class="mt-2 font-medium text-sm md:text-lg">Type</h3>
                              <ul class="ml-5 text-xs sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
            ...
            <div class="text-neutral" >
              <div data-aos="fade-down" class="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8" >
                <div class="mx-auto max-w-lg text-center">
                  <h2 class="text-2xl md:text-4xl font-bold">Accommodation Type</h2>
                </div>
            
                <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 place-items-center place-content-stretch">
                  <div class="block place-self-stretch rounded-xl border p-8 shadow-xl transition bg-base-100" data-aos="flip-right" >
      ...
      <section class="bg-base-100 text-gray-600 p-14 w-full">
          <div data-aos="fade-down" class="px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
            <div class="w-full flex flex-col items-center">
              <h2 class="text-2xl md:text-4xl font-bold">Rooms Services</h2>
            ...
            <div class="mt-20 grid grid-cols-1 md:grid-cols-3 gap-10 place-items-center place-content-stretch">
              @foreach ($rooms as $room)
                  <div data-aos="zoom-in-up" class="card w-72 bg-base-100 shadow-xl">
      ...
      <section class="bg-base-100 text-gray-600 p-14 w-full">
        <div data-aos="fade-down" class="px-4 sm:px-6 lg:px-8">
          <div class="w-full flex flex-col items-center">
            <h2 class="text-2xl md:text-4xl font-bold">Rides Offers</h2>
          ...
          <div class="w-full mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 place-items-center place-content-stretch">
            <div data-aos="zoom-in-down" class="card w-72 bg-base-100 shadow-xl">
              <figure><img src="{{asset('images/accommodation/destinations/atv-ride.jpg')}}" alt="All Terrain Vehicle Pics" class="object-cover h-80" /></figure>
              <div class="card-body flex justify-between">
                <h2 class="card-title text-center">All Terrain Vehicle Motors</h2>
              </div>
            </div>
            <div data-aos="zoom-in-down" class="card w-72 bg-base-100 shadow-xl">
              <figure><img src="{{asset('images/accommodation/destinations/4x4-ride.jpg')}}" alt="All Terrain Vehicle Pics" class="object-cover h-80" /></figure>
              <div class="card-body flex justify-between">
                <h2 class="card-title text-center">4x4 Jeep Wrangler Old Model</h2>
              </div>
            </div>
