    ...
    <x-system-content title="Let's Edit {{$ride->model}}">
      ...
      <div class="mt-8 w-full flex flex-col md:flex-row justify-evenly space-y-10 items-center">
        <div class="md:w-96 flex flex-col justify-center items-start">
          <div class="avatar">
            <div class="w-full p-3 border-2 border-dashed rounded-md border-primary text-neutral">
              <img id="room_img" src="{{$ride->image ? asset('storage/' . $ride->image)  : asset('images/avatars/no-avatar.png')}}" alt="Room Image" />
            </div>
          </div>
        ...
        <div class="w-full md:w-96">
            ...
            <label for="edit_modal" class="btn btn-primary w-full">Edit Ride</label>
