    ...
    <x-system-content title="" back=true>
        ...
        <div class="flex justify-between items-center space-x-1">
            ...
            <div class="tabs tabs-boxed bg-transparent items-center">
                <a @click="tab = 'TA' " :class="tab == 'TA' ? 'tab tab-active' : 'tab' ">Tour Addons</a> 
                <a @click="tab = 'OA' " :class="tab == 'OA' ? 'tab tab-active' : 'tab'">Other Addons</a> 
            </div>
        </div>
        <div class="divider"></div>
            <article x-show="tab == 'TA' " x-data="{gpax: ''}" class="block w-full">
                <div class="w-full">
                    <div class="gap-10">
            ...
            <article class="w-full flex justify-center">
                <form id="other-form" action="" method="POST" class="w-96">
                    @csrf
                    @method('PUT')
